...
-- Komenda na nadanie WL
TriggerEvent('es:addGroupCommand', 'nadajwl', "mod", function(source, args, user)
...
-- Komenda na zabranie WL
TriggerEvent('es:addGroupCommand', 'zabierzwl', "mod", function(source, args, user)
...
-- Komenda na odswiezenie WL
TriggerEvent('es:addGroupCommand', 'odswiezwl', "mod", function(source, args, user)
...
-- Rcon Nadanie Whitelist (Supports Ace)
RegisterCommand("rconnadajwl", function(source, args, rawCommand)
    addToWhitelist(args, "", true)
end, true)

-- Rcon Zabranie Whitelist (Supports Ace)
RegisterCommand("rconzabierzwl", function(source, args, rawCommand)
    removeFromWhitelist(args, "", true)
end, true)

-- Rcon Odswiezanie Whitelist (Supports Ace)
RegisterCommand("rconodswiezwl", function(source, args, rawCommand)
    for i = 0, #Whitelist do
        Whitelist[i] = nil
    end
